...
export function Avatar({ name, src, size = 180 }: { name: string; src?: string; size?: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -inset-2 rounded-full bg-linear-to-br from-accent via-accent-soft to-accent opacity-70 blur-xl animate-pulse-glow -z-10" />
      <div className="absolute -inset-1 rounded-full bg-linear-to-br from-accent to-accent-soft opacity-50 blur-md -z-10" />
